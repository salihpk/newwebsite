    ...
    <div className="particles-container">
      {particles.map(p => (
        <motion.div
          ...
          animate={{ y: [0, -28, 6, 0], x: [0, 12, -8, 0], opacity: [0.12, 0.55, 0.25, 0.12] }}
...
const Home = ({ isSpidoMode, setIsSpidoMode, discordAvatar }) => {
  ...
  const [subtextDisplay, setSubtextDisplay] = useState('');
  ...
  useEffect(() => {
    const full = 'Cybersecurity Aspirant  |  AI Enthusiast  |  Creative Developer';
    let i = 0;
    const timer = setInterval(() => {
      if (i <= full.length) { setSubtextDisplay(full.slice(0, i)); i++; }
    ...
    <PageTransition className="page-container home-page">
      <div className="hero-section">
        ...
        <div className="hero-content">
          ...
          >
            {subtextDisplay}<span className="subtext-cursor">|</span>
          </motion.p>
